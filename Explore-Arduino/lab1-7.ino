...
//
// Description:
//     Print the results for homework 1 Problem 1 on the UNO through serial monitor
//
// Rev.0 28,June 2017
// ----------------------------------

// People count, 9 people in total
int cntPerson = 9;

// The cost per person
float baseCost = 977.50f;
...
float baseTotalCost = cntPerson * baseCost;

// Take discount into count
float discountTotalCost = baseTotalCost * (1 - discount);

// Take tax into count
float totalCost = discountTotalCost * (1 + tax);
